...
{
    public partial class GuardarDiezmo : Form
    {
        public GuardarDiezmo()
        {
            InitializeComponent();
        }
        public void Nuevo()
        ...
        private void GuardarDiezmo_Load(object sender, EventArgs e)
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(clase.GuardarDiezmo());
            }
        }
